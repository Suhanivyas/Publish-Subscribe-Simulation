...
/**
 * class  Subscriber--- Used to store details of each subscriber
 * Example: Subscriber Suhani subscribes topics Health,Food and Books in PULL mode. 
 * name= Suhani
 * type=PULL
 * timeStamp= Stored the timestamp at which user subscribes the topic.
 * subscribedPublishers=[ Health,Food , Books] 
 * @author    Suhani Vyas 
 */

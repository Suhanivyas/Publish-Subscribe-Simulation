...
/**
 * class  TopicPublisher--- Used to store details of topic and its published data. 
 * Example: Topic Health has subscriber Suhani,Yamini in PULL mode and Shamvi,Akshita in PUSH mode.
 * topicName= Health 
 * dataList= Stores the data related to health
 * pullReqSubscribers= [ Suhani,Yamini ]
 * pullReqSubscribers=[Shamvi,Akshita] 
 * @author    Suhani Vyas 
 */
